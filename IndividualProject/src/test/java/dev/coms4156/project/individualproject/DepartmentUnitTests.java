...
public class DepartmentUnitTests {
  ...
  public void setupDepartmentForTesting() {
    ...
    Course testCourse1 = new Course(INSTRUCTOR_NAME_1, LOCATION_1, TIME_SLOT_1, COURSE_CAPACITY_1);
  ...
  public void createCourseTest() {
    testDepartment.createCourse(COURSE_CODE_2, INSTRUCTOR_NAME_2, LOCATION_2, TIME_SLOT_2,
        COURSE_CAPACITY_2);
    assertTrue(testDepartment.getCourseSelection().containsKey(COURSE_CODE_2));
    Course currentCourse = testDepartment.getCourseSelection().get(COURSE_CODE_2);
    assertEquals(INSTRUCTOR_NAME_2, currentCourse.getInstructorName());
    assertEquals(LOCATION_2, currentCourse.getCourseLocation());
    assertEquals(TIME_SLOT_2, currentCourse.getCourseTimeSlot());
  }
